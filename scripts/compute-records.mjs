...
const DEFINITIONS = [
  ...
  { key: "alltime_unluckiest_season", title: "Unluckiest Season", description: "Largest deficit between all-play expected wins and actual wins, regular season only.", scope: "alltime", direction: "asc" },
  { key: "alltime_luckiest_season", title: "Luckiest Season", description: "Smallest deficit between all-play expected wins and actual wins, regular season only (see engine.ts: this can never be a true surplus).", scope: "alltime", direction: "desc" },
  ...
  { key: "season_luck_score", title: "Season Luck Score", description: "Every manager's all-play luck gap (actual wins − would-be wins) that season, regular season only. Never positive — see engine.ts.", scope: "season", direction: "desc" },
